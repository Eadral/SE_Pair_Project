...
public:
    ...
    INTERSECT_API static bool PointOnRay(const double& x, const double& y, const Ray& r);

    INTERSECT_API static bool PointOnSection(const double& x, const double& y, const Section& s);
